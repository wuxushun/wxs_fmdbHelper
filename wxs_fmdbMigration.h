...
//----------------------------------------------------------------------
//
// 鸣谢原作者 Blake Watters，本迁移功能完全参照原作者源码，仅进行翻译以及库名统一
// 保留原作者所有信息
//
//----------------------------------------------------------------------
 ...
 */
@interface wxs_fmdbMigration : NSObject
 ...
 */
@protocol wxs_fmdbMigrating <NSObject>
 ...
 */
@interface wxs_fmdbFileMigration : NSObject <wxs_fmdbMigrating>
 ...
 */
extern NSString *const wxs_fmdbMigrationManagerErrorDomain;
 ...
 */
extern NSString *const wxs_fmdbMigrationManagerProgressVersionUserInfoKey;
...
/**
 ...
 @see `migrateDatabase:error:`
 */
extern NSString *const wxs_fmdbMigrationManagerProgressMigrationUserInfoKey;

/**
 @abstract Enumerates the errors returned by FMDBMigrationManager
 */
typedef NS_ENUM(NSUInteger, wxs_fmdbMigrationManagerError) {
    /// Indicates that migration was halted due to cancellation
    wxs_fmdbMigrationManagerErrorMigrationCancelled  = 1
};
